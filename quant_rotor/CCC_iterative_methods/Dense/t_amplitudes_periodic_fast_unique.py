...
def t_periodic(
    ...
    if Import_t:
        ...
        t_a_i_tensor = np.full((a), 0.0, dtype=complex)
        t_ab_ij_tensor = np.full((site, a, a), 0.0, dtype=complex)
    ...
    terms.V_iiap = qs.v_term(i, i, a, p, 0, 1).reshape(a, p)
    ...
    while True:
        ...
        for y in range(site):
            double[y] = qs.residual_double_total(y)
