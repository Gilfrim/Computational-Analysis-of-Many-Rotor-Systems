...
def hamiltonian(sites:int, states:int, mix_factor:float = 0, g:float = 1,  onesite:bool = True, twosite:bool = True, timer = False)->np.array:
    ...
    file_path = r"/Users/gilfrim/Desktop/Projects/Computational_Analysis_of_Many_Rotor_Systems/z_non_periodic"
    ...
    if onesite:
        ...
        with open(
            file_path + r"/matrix_elements_K.csv", mode="r", newline=""
        ) as csvfile_h_1:
    ...
    if twosite:
        ...
        with open(
            file_path + r"/matrix_elements_V.csv", mode="r", newline=""
        ) as csvfile_v_1:
...
if __name__ == "__main__":
    ...
    gee = 10
    # mix = -0.05
    ham = hamiltonian(site, state, 0, gee)
    print(ham)
